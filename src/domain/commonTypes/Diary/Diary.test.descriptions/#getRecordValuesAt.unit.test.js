...
describe('Domain :: entities :: Diary :: #getRecordValuesAt', () => {
  ...
  context('when diary have no diary', () => {
    ...
    context('when no props passed', () => {
      test('should return empty array', () => {
        expect(diary.getRecordValuesAt()).toEqual([]);
      });
    });
  });
  ...
  context('when diary have diary and not closed', () => {
    ...
    context('when passed day of first appointment', () => {
      test('should return array with first appointment value', () => {
        expect(diary.getRecordValuesAt(day2)).toEqual([value1]);
      });
    });
    context('when passed day between first and second diary', () => {
      test('should return array with first appointment value', () => {
        expect(diary.getRecordValuesAt(day3)).toEqual([value1]);
      });
    });
    context('when passed day of appointment after first', () => {
      test('should return array with all values between first appointment and passed day', () => {
        expect(diary.getRecordValuesAt(day4)).toEqual([value1, value2]);
      });
    });
    context('when no props passed', () => {
      test('should return array with all values between first appointment and passed day', () => {
        expect(diary.getRecordValuesAt()).toEqual([value1, value2]);
      });
    });
  });
  ...
  context('when diary have closed', () => {
    ...
    context('when passed day between last appointment and close', () => {
      test('should return array with all values between first appointment and passed day', () => {
        expect(diary.getRecordValuesAt(day5)).toEqual([value1, value2]);
      });
    });
    context('when passed close day', () => {
      test('should return empty array', () => {
        expect(diary.getRecordValuesAt(day6)).toEqual([]);
      });
    });
    context('when no props passed', () => {
      test('should return empty array', () => {
  ...
  context('when diary have closed, started again and close again', () => {
    ...
    context('when passed day after second start day', () => {
      test('should return array with all values between first appointment and passed day', () => {
        expect(diary.getRecordValuesAt(day9)).toEqual([value2]);
      });
    });
    context('when passed second close day', () => {
      test('should return empty array', () => {
        expect(diary.getRecordValuesAt(day10)).toEqual([]);
      });
    });
    context('when no props passed', () => {
      test('should return empty array', () => {
