...
describe('Domain :: entities :: ValueDayProgress :: #_getNextInterruptDayAt', () => {
  ...
  context('when valueDayProgress have no items', () => {
    context('when passed custom day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day1)).toBeUndefined();
      });
    });

    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt()).toBeUndefined();
      });
    });
  });
  ...
  context('when valueDayProgress have items and not interrupted', () => {
    ...
    context('when passed day of first item', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day2)).toBeUndefined();
      });
    });
    context('when passed day between first and second items', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day3)).toBeUndefined();
      });
    });
    context('when passed day of item after first', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day4)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context('when valueDayProgress have interrupted', () => {
    ...
    context('when passed day before items', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day1)).toBe(day6);
      });
    });
    context('when passed day of first item', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day2)).toBe(day6);
      });
    });
    context('when passed day between first and second items', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day3)).toBe(day6);
      });
    });
    context('when passed day of item after first', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day4)).toBe(day6);
      });
    });
    context('when passed day between last item and interrupt', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day5)).toBe(day6);
      });
    });
    context('when passed interrupt day', () => {
      test('should return interrupt day', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day6)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return interrupt day', () => {
  ...
  context('when valueDayProgress have interrupted and started again', () => {
    ...
    context('when passed day between interrupt and second start', () => {
      test('should return interrupt day', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day7)).toBeUndefined();
      });
    });
    context('when passed second start day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getNextInterruptDayAt(day8)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context(
    ...
    () => {
      ...
      context('when passed interrupt day', () => {
        test('should return interrupt day', () => {
          expect(valueDayProgress._getNextInterruptDayAt(day6)).toBe(day10);
        });
      });
      context('when passed day between interrupt and second start', () => {
        test('should return interrupt day', () => {
          expect(valueDayProgress._getNextInterruptDayAt(day7)).toBe(day10);
        });
      });
      context('when passed second start day', () => {
        test('should return undefined', () => {
          expect(valueDayProgress._getNextInterruptDayAt(day8)).toBe(day10);
        });
      });
      context('when passed day after second start day', () => {
        test('should return undefined', () => {
          expect(valueDayProgress._getNextInterruptDayAt(day9)).toBe(day10);
        });
      });
      context('when passed second interrupt day', () => {
        test('should return second interrupt day', () => {
          expect(
            valueDayProgress._getNextInterruptDayAt(day10)
          ).toBeUndefined();
        });
      });
      context('when no props passed', () => {
