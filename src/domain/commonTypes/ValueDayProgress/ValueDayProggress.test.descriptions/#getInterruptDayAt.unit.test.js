...
describe('Domain :: entities :: ValueDayProgress :: #getInterruptDayAt', () => {
  ...
  context('when valueDayProgress have no items', () => {
    context('when passed custom day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day1)).toBeUndefined();
      });
    });

    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt()).toBeUndefined();
      });
    });
  });
  ...
  context('when valueDayProgress have items and not interrupted', () => {
    ...
    context('when passed day of first item', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day2)).toBeUndefined();
      });
    });
    context('when passed day between first and second items', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day3)).toBeUndefined();
      });
    });
    context('when passed day of item after first', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day4)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context('when valueDayProgress have interrupted', () => {
    ...
    context('when passed day between last item and interrupt', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day5)).toBeUndefined();
      });
    });
    context('when passed interrupt day', () => {
      test('should return interrupt day', () => {
        expect(valueDayProgress.getInterruptDayAt(day6)).toBe(day6);
      });
    });
    context('when no props passed', () => {
      test('should return interrupt day', () => {
        expect(valueDayProgress.getInterruptDayAt()).toBe(day6);
      });
    });
  });
  ...
  context('when valueDayProgress have interrupted and started again', () => {
    ...
    context('when passed day between interrupt and second start', () => {
      test('should return interrupt day', () => {
        expect(valueDayProgress.getInterruptDayAt(day7)).toBe(day6);
      });
    });
    context('when passed second start day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getInterruptDayAt(day8)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context(
    ...
    () => {
      ...
      context('when passed day after second start day', () => {
        test('should return undefined', () => {
          expect(valueDayProgress.getInterruptDayAt(day9)).toBeUndefined();
        });
      });
      context('when passed second interrupt day', () => {
        test('should return second interrupt day', () => {
          expect(valueDayProgress.getInterruptDayAt(day10)).toBe(day10);
        });
      });
      context('when no props passed', () => {
        test('should return second interrupt day', () => {
          expect(valueDayProgress.getInterruptDayAt()).toBe(day10);
        });
      });
    }
  );
