...
describe('Domain :: entities :: ValueDayProgress :: #interruptDay', () => {
  ...
  context('when valueDayProgress have no items', () => {
    test('should return undefined', () => {
      expect(valueDayProgress.interruptDay).toBeUndefined();
    });
  });
  ...
  context('when valueDayProgress have interrupted', () => {
    ...
    test('should return interrupt day', () => {
      expect(valueDayProgress.interruptDay).toBe(day6);
    });
  });
  ...
  context(
    ...
    () => {
      ...
      test('should return second interrupt day', () => {
        expect(valueDayProgress.interruptDay).toBe(day10);
      });
    }
  );
});
