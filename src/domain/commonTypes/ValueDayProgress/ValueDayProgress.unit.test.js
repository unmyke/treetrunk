...
const interruptItem = new MockItem({ value: interruptValue, day: day4 });
...
const interruptedItems = [item1, item2, interruptItem];
const items = [item1, item2, interruptItem, item3];
  ...
  context('when passed not interrupt item', () => {
    context('when items is empty', () => {
      context('when initialized', () => {
        ...
        test('should have interrupt day undefined', () => {
          expect(coll.interruptDay).toBeUndefined();
        });
        ...
        context('when no item exists at passed day', () => {
          ...
          context('when passed item value is not the same as persisted', () => {
            context('when passed day is sooner than start day', () => {
              context('when interrupt exists at passed day', () => {
                context('when passed day is sooner than interrupt day', () => {
                  beforeEach(() => {
                    coll.addItem({
                      value: 3,
                      day: day3,
                ...
                context('when passed day is later than interrupt day', () => {
                  beforeEach(() => {
                    result = coll.addItem(
                      new MockItem({
                        value: 4,
              ...
              context('when interrupt not exists at passed day', () => {
                beforeEach(() => {
                  result = coll.addItem(
                    new MockItem({
                      value: 4,
    ...
    context('when items is interrupted', () => {
      ...
      describe('#add', () => {
        context('when passed interrupt item', () => {
          beforeEach(() => {
            result = coll.addItem(interruptItem);
          });
      ...
      describe('#delete', () => {
        context('when interrupt item exists at passed day', () => {
          beforeEach(() => {
            result = coll.deleteItem(interruptItem);
          });
        ...
        context('when no interrupt item exists at passed day', () => {
          ...
          test('should return unsuccessful result', () => {
            expect(result).toEqual({
              ...
              errors: [
                'Mock item with value "interrupt" at 20.04.2017 not found',
              ],
            });
          });
      ...
      describe('#edit', () => {
        beforeEach(() => {
          result = coll.editItem(interruptItem, interruptItem);
        });
  ...
  context('when passed interrupt item', () => {
    describe('#add', () => {
      ...
      test('should return unsuccessful result', () => {
        expect(result).toEqual({
          ...
          errors: ['Interrupt item not allowed by add method'],
        });
      });
    ...
    describe('#delete', () => {
      ...
      test('should return unsuccessful result', () => {
        expect(result).toEqual({
          ...
          errors: ['Interrupt item not allowed by delete method'],
        });
      });
    ...
    describe('#edit', () => {
      context('when passed as item to edit', () => {
        beforeEach(() => {
          result = coll.editItem(interruptItem);
        });
        ...
        test('should return unsuccessful result', () => {
          expect(result).toEqual({
            ...
            errors: {
              item: ['Interrupt item not allowed by edit method'],
            },
          });
        });
      ...
      context('when passed as new item', () => {
        beforeEach(() => {
          result = coll.editItem(interruptItem1);
        });
        ...
        test('should return unsuccessful result', () => {
          expect(result).toEqual({
            ...
            errors: {
              newItem: ['Interrupt item not allowed by edit method'],
            },
          });
        });
