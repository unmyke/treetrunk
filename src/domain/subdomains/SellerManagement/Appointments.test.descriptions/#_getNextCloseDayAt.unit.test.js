...
describe('Domain :: entities :: Appointments :: #_getNextCloseDayAt', () => {
  ...
  context('when appointments have no appointments', () => {
    context('when passed custom day', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day1)).toBeUndefined();
      });
    });

    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt()).toBeUndefined();
      });
    });
  });
  ...
  context('when appointments have appointments and not closed', () => {
    ...
    context('when passed day of first appointment', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day2)).toBeUndefined();
      });
    });
    context('when passed day between first and second appointments', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day3)).toBeUndefined();
      });
    });
    context('when passed day of appointment after first', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day4)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context('when appointments have closed', () => {
    ...
    context('when passed day before appointments', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day1)).toBe(day6);
      });
    });
    context('when passed day of first appointment', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day2)).toBe(day6);
      });
    });
    context('when passed day between first and second appointments', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day3)).toBe(day6);
      });
    });
    context('when passed day of appointment after first', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day4)).toBe(day6);
      });
    });
    context('when passed day between last appointment and close', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day5)).toBe(day6);
      });
    });
    context('when passed close day', () => {
      test('should return close day', () => {
        expect(appointments._getNextCloseDayAt(day6)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return close day', () => {
  ...
  context('when appointments have closed and recruited again', () => {
    ...
    context('when passed day between close and second recruit', () => {
      test('should return close day', () => {
        expect(appointments._getNextCloseDayAt(day7)).toBeUndefined();
      });
    });
    context('when passed second recruit day', () => {
      test('should return undefined', () => {
        expect(appointments._getNextCloseDayAt(day8)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context(
    ...
    () => {
      ...
      context('when passed close day', () => {
        test('should return close day', () => {
          expect(appointments._getNextCloseDayAt(day6)).toBe(day10);
        });
      });
      context('when passed day between close and second recruit', () => {
        test('should return close day', () => {
          expect(appointments._getNextCloseDayAt(day7)).toBe(day10);
        });
      });
      context('when passed second recruit day', () => {
        test('should return undefined', () => {
          expect(appointments._getNextCloseDayAt(day8)).toBe(day10);
        });
      });
      context('when passed day after second recruit day', () => {
        test('should return undefined', () => {
          expect(appointments._getNextCloseDayAt(day9)).toBe(day10);
        });
      });
      context('when passed second close day', () => {
        test('should return second close day', () => {
          expect(appointments._getNextCloseDayAt(day10)).toBeUndefined();
        });
      });
      context('when no props passed', () => {
        test('should return second close day', () => {
