...
describe('Domain :: entities :: Appointments :: #_getPrevCloseDayAt', () => {
  ...
  context('when valueDayProgress have no appointments', () => {
    context('when passed custom day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day1)).toBeUndefined();
      });
    });

    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt()).toBeUndefined();
      });
    });
  });
  ...
  context('when valueDayProgress have appointments and not closeed', () => {
    ...
    context('when passed day of first appointment', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day2)).toBeUndefined();
      });
    });
    context('when passed day between first and second appointments', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day3)).toBeUndefined();
      });
    });
    context('when passed day of appointment after first', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day4)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context('when valueDayProgress have closeed', () => {
    ...
    context('when passed day between last appointment and close', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day5)).toBeUndefined();
      });
    });
    context('when passed close day', () => {
      test('should return close day', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day6)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return close day', () => {
        expect(valueDayProgress._getPrevCloseDayAt()).toBe(day6);
      });
    });
  });
  ...
  context('when valueDayProgress have closeed and recruited again', () => {
    ...
    context('when passed day between close and second recruit', () => {
      test('should return close day', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day7)).toBe(day6);
      });
    });
    context('when passed second recruit day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress._getPrevCloseDayAt(day8)).toBe(day6);
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context(
    ...
    () => {
      ...
      context('when passed day after second recruit day', () => {
        test('should return undefined', () => {
          expect(valueDayProgress._getPrevCloseDayAt(day9)).toBe(day6);
        });
      });
      context('when passed second close day', () => {
        test('should return second close day', () => {
          expect(valueDayProgress._getPrevCloseDayAt(day10)).toBe(day6);
        });
      });
      context('when no props passed', () => {
        test('should return second close day', () => {
          expect(valueDayProgress._getPrevCloseDayAt()).toBe(day10);
        });
      });
    }
  );
