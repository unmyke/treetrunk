...
describe('Domain :: entities :: Appointments :: #getAppointmentValueAt', () => {
  let valueDayProgress;
  beforeEach(() => {
    valueDayProgress = new Appointments({
      AppointmentCalss: PieceRate,
    });
  });
  ...
  context('when valueDayProgress have no appointments', () => {
    context('when passed custom day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getAppointmentValueAt(day1)).toBeUndefined();
      });
    });

    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getAppointmentValueAt()).toBeUndefined();
      });
    });
  });
  ...
  context('when valueDayProgress have appointments and not closeed', () => {
    ...
    context('when passed day of first appointment', () => {
      test('should return value of first appointment', () => {
        expect(valueDayProgress.getAppointmentValueAt(day2)).toBe(value1);
      });
    });
    context('when passed day between first and second appointments', () => {
      test('should return value of first appointment', () => {
        expect(valueDayProgress.getAppointmentValueAt(day3)).toBe(value1);
      });
    });
    context('when passed day of appointment after first', () => {
      test('should return value of appointment', () => {
        expect(valueDayProgress.getAppointmentValueAt(day4)).toBe(value2);
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getAppointmentValueAt()).toBe(value2);
      });
    });
  });
  ...
  context('when valueDayProgress have closeed', () => {
    ...
    context('when passed day between last appointment and close', () => {
      test('should return value of appointment', () => {
        expect(valueDayProgress.getAppointmentValueAt(day5)).toBe(value2);
      });
    });
    context('when passed close day', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getAppointmentValueAt(day6)).toBeUndefined();
      });
    });
    context('when no props passed', () => {
      test('should return undefined', () => {
  ...
  context('when valueDayProgress have closeed and recruited again', () => {
    ...
    context('when passed day between close and second recruit', () => {
      test('should return undefined', () => {
        expect(valueDayProgress.getAppointmentValueAt(day7)).toBeUndefined();
      });
    });
    context('when passed second recruit day', () => {
      test('should return value of second recruit', () => {
        expect(valueDayProgress.getAppointmentValueAt(day8)).toBe(value2);
      });
    });
    context('when no props passed', () => {
      test('should return value of second recruit', () => {
  ...
  context(
    ...
    () => {
      ...
      context('when passed day after second recruit day', () => {
        test('should return value of second recruit', () => {
          expect(valueDayProgress.getAppointmentValueAt(day9)).toBe(value2);
        });
      });
      context('when passed second close day', () => {
        test('should return undefined', () => {
          expect(valueDayProgress.getAppointmentValueAt(day10)).toBeUndefined();
        });
      });
      context('when no props passed', () => {
        test('should return undefined', () => {
