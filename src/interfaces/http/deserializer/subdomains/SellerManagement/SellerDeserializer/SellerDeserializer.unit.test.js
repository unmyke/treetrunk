...
import { SellerDeserializer as Deserializer } from './SellerDeserializer';
import {
  Seller,
  Post,
  SeniorityType,
} from 'src/domain/subdomains/SellerManagement';
import { SellerId, Day, PostId, SeniorityTypeId } from 'src/domain/commonTypes';
...
const serializer = new Deserializer();
